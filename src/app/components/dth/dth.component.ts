...
export class DthComponent implements OnInit {
  ...
  constructor(private router:Router, private toastr:ToastrService, private dataservice :DataService,private formBuilder: FormBuilder, private billing: BillingserviceService) {
  ...
  get f() { return this.dth.controls; }
  ...
  onSubmit() {
    ...
    this.billing.postdthPayment(formData).subscribe(
      (data) => {
        console.log(data);
